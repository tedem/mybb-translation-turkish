...
$l['forum_unapproved_posts_count'] = "Bu forumda şu anda {1} onaylanmamış mesaj bulunmaktadır.";
$l['forum_unapproved_post_count'] = "Bu forumda şu anda 1 onaylanmamış mesaj bulunmaktadır.";
...
$l['pms_unread_total'] = "(Tüm klasörlerinizde {1} okunmamış ve toplam {2} mesajınız var.)";
$l['stats_posts_threads'] = "Üyelerimiz toplam {1} mesaj yazdı, {2} konuda.";
$l['stats_numusers'] = "Şu anda {1} kayıtlı üyemiz var.";
$l['stats_newestuser'] = "Lütfen en yeni üyemizi karşılayın";
$l['stats_mostonline'] = "En yüksek çevrimiçi kullanıcı sayısı {1} olup, {2} tarihinde kaydedilmiştir.";
...
$l['online_note'] = "{1} {2} aktif, son {3} dakika içinde ({4} {5}, {6} tanesi {7} görünmez, ve {8} {9}).";
